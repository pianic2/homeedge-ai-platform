...
| [ADR-0002](ADR-0002-environmental-sensor-profiles.md) | Environmental Sensor Profiles | Accepted | [IHAP-45](https://niccolopiazzi01.atlassian.net/browse/IHAP-45) | Pending | Selects DHT11 as the standard indoor profile and BME280 as the precision / extended-environment profile. DHT22 is not selected. Absolute accuracy remains `[UNVALIDATED]`; pressure remains outside the MVP measurement contract. |
