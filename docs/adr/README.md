...
| [ADR-0003](ADR-0003-local-status-display.md) | Local Status Display | Proposed | [IHAP-53](https://niccolopiazzi01.atlassian.net/browse/IHAP-53) | Pending | Proposes one 0.96-inch-class 128×64 monochrome I2C local status/debug display for the reference MVP. The owned blue `GME12864-11-12-13 V3.22` specimen is a conditional candidate pending physical validation. |
