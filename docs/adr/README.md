...
Only the Project Owner can accept, reject or supersede an ADR. If an Accepted ADR contains a later amendment proposal, the ADR must clearly preserve the Accepted baseline and mark the amendment **Proposed** until a new Project Owner decision exists.
