...
| [ADR-0007](ADR-0007-edge-power-subsystem.md) | Edge Power Subsystem | **Accepted** | [IHAP-49](https://niccolopiazzi01.atlassian.net/browse/IHAP-49) | [PR #34](https://github.com/pianic2/homeedge-ai-platform/pull/34) | Accepted 2026-09-07. Regulated 5 V USB-C is the normal source, LG INR18650-MJ1 is the selected 1S backup cell, and the final implementation converges to a custom modular core PCB with MP2636GR-P as the preferred first integrated PMIC. No-reset transfer and measured backup autonomy remain `[UNVALIDATED]` pending IHAP-55. |
