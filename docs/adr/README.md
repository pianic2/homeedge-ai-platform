...
| [ADR-0003](ADR-0003-mvp-central-node-hardware-profile.md) | MVP Central Node Hardware Profile | Proposed | [IHAP-52](https://niccolopiazzi01.atlassian.net/browse/IHAP-52) | [PR #30](https://github.com/pianic2/homeedge-ai-platform/pull/30) | Defines the vendor-neutral central-node minimum profile and Raspberry Pi 4 Model B >=4 GB / 64 GB A2 reference candidate. Raspberry Pi 4 validation, workload sufficiency, storage endurance and AI acceleration remain `[UNVALIDATED]`; Raspberry Pi 5 is a compatible newer candidate, not yet community-validated. |
