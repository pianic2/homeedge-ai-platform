...
| [ADR-0005](ADR-0005-mvp-presence-sensor.md) | MVP Presence Sensor | Proposed | [IHAP-46](https://niccolopiazzi01.atlassian.net/browse/IHAP-46) | [PR #25](https://github.com/pianic2/homeedge-ai-platform/pull/25) | Proposes HLK-LD2410C-class 24 GHz radar for local boolean presence only. Empty-room and strict moving-entry evidence exist for one owned V1.1 specimen; stationary, release and adjacent-space gates plus Project Owner acceptance remain pending. |
