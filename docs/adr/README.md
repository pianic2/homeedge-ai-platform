...
| [ADR-0007](ADR-0007-edge-power-subsystem.md) | Edge Power Subsystem | **Proposed** | [IHAP-49](https://niccolopiazzi01.atlassian.net/browse/IHAP-49) | [PR #34](https://github.com/pianic2/homeedge-ai-platform/pull/34) | Proposes regulated 5 V USB-C as the normal edge-node source with a rechargeable 1S Li-ion path retained only as backup for blackout or cable/input interruption. Exact cell, holder, converter, source-selection behavior and measured backup autonomy remain `[UNVALIDATED]`. |
