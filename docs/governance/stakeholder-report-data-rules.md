...
| Production-ready, certified, safety-critical, commercial-ready, security-grade claims | Blocked unless proven | Require traceable evidence and Project Owner decision. |

---

## 3. Claim Handling

Use the weakest accurate maturity label.
...
```text
Looks done, probably secure, production-ready, certified, or reliable.
```
...
When a report mentions presence, door state, backend services, AI insight, Kafka, security, safety, or production maturity, it must either link evidence or preserve `[UNVALIDATED]`.
