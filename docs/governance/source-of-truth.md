...
| Risk Assessment template | `docs/templates/risk-assessment.md` | Jira/PR evidence links | Provides a minimal template for future risk assessments; risk records are created only by explicit task need. |
