...
| Risk Model Baseline | `docs/risks/risk-model-baseline.md` | Jira/PR evidence links, Confluence summary | Defines risk categories, scoring, residual risk treatment, evidence expectations, authority boundaries, and stakeholder risk visibility. |
...
`docs/risks/` is now a canonical risk documentation area. `docs/risks/risk-model-baseline.md` defines the project risk model. `docs/templates/risk-assessment.md` remains only a reusable template and does not accept any risk by itself.
...
7. Read `docs/governance/shift-left-governance-baseline.md` for the mandatory issue-level Shift Left impact block.
8. Read `docs/governance/scrum-governance-dor-dod.md` before evaluating Definition of Ready, Definition of Done, Jira workflow movement, or minimum evidence expectations.
9. Read `docs/governance/ai-review-agents-policy.md` for advisory review-agent roles, severity model, and decision limits.
10. Read `docs/governance/ai-review-agent-playbook.md` for concrete review-agent prompts and review-output format.
11. Read `docs/governance/governance-lane-review-gate.md` before evaluating governance-lane movement toward Review, Stakeholder Review, or Done.
12. Read `docs/governance/team-working-rules.md` before changing daily collaboration rules, blocker handling, evidence discipline, working agreements, or AI assistant usage boundaries.
13. Read `docs/governance/engineering-assistant-rules.md` before using or changing engineering assistant operating boundaries, allowed actions, forbidden actions, or assistant evidence rules.
14. Read `docs/adr/README.md` before adding or changing ADRs, ADR naming, ADR status, or ADR link policy.
15. Read `docs/adr/template.md` before drafting a new ADR.
16. Read `docs/product/product-vision.md` for Product Vision, MVP boundaries, and current glossary.
17. Read `docs/governance/stakeholder-transparency.md` for stakeholder visibility and Atlassian governance rules.
18. Read `docs/governance/stakeholder-report-data-rules.md` before changing what stakeholder reports may show, link, redact, or block.
19. Use Jira for task state, workflow, review state, blockers, and evidence links.
20. Use Confluence for stakeholder hub, stakeholder reports, stakeholder forms, and navigation.
...
- source-of-truth responsibility is defined for backlog, task state, code, documents, Docs Landing Page, Product Vision, ADRs, Risk Model Baseline, Risk Assessments, Templates, stakeholder hub, stakeholder reports, stakeholder report data rules, PR evidence, runtime evidence, Documentation Strategy, Scrum Governance DoR/DoD, Governance Lane Review Gate, Team Working Rules, Engineering Assistant Rules, ADR index/template, and `[UNVALIDATED]` claims;
...
- canonical repository paths are listed, including `docs/README.md`, `docs/governance/documentation-strategy.md`, `docs/templates/README.md`, `docs/templates/risk-assessment.md`, `docs/risks/README.md`, `docs/risks/risk-model-baseline.md`, `docs/governance/scrum-governance-dor-dod.md`, `docs/governance/governance-lane-review-gate.md`, `docs/governance/team-working-rules.md`, `docs/governance/engineering-assistant-rules.md`, `docs/governance/stakeholder-report-data-rules.md`, `docs/adr/README.md`, and `docs/adr/template.md`;
