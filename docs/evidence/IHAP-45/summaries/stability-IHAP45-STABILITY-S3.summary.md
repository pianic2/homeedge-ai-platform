# IHAP-45 Functional Stability Summary — IHAP45-STABILITY-S3

**Configuration:** `S3-board-bme280-dht22`  
**Status:** `PASSED`  
...
| Check | Result |
|---|---:|
| Qualification duration | 300.0 s |
| Completed window | true |
| Boot records | 1 |
| Brownout events | 0 |
| USB disconnects after start | 0 |
| Valid sample records | 120 |
